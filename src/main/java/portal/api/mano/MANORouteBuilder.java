...
public class MANORouteBuilder  extends RouteBuilder{
	...
	public void configure() {
		...
		from("timer://checkAndUpdateRunningDeploymentDescriptors?delay=1m&period=240000").bean(MANOController.class,"checkAndUpdateRunningDeploymentDescriptors").stop();
